...
def main():
    ...
    # Use from_pretrained if checkpoint is a HuggingFace model ID (contains "/")
    if "/" in args.checkpoint and not os.path.exists(args.checkpoint):
        model = YOLOE.from_pretrained(args.checkpoint)
    else:
